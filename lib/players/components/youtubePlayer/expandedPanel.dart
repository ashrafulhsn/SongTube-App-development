...
class _YoutubePlayerVideoPageState extends State<YoutubePlayerVideoPage>
  ...
  Widget build(BuildContext context) {
    ...
    if (bottomSheetController != null &&
        pageProvider.fwController.panelPosition < 1) {
      try {
            ...
            builder: (context, child) {
              return Opacity(
                opacity: (animationController.value -
                    ...
                    : 0,
                child: Align(
                    heightFactor: animationController.value, child: child),
              );
            },
            child: Column(
              children: [
            ...
            children: [
              Container(
                ...
                child: MoreDetailsSheet(
                  video: pageProvider.currentVideo,
                  segments: pageProvider?.currentVideo?.segments ?? [],
                  onSegmentTap: (position) => pageProvider
                      .playerKey.currentState.controller
                    ...
                    child: FadeInImage(
                      ...
                      image: pageProvider.currentChannel != null
                          ? isURL(pageProvider.currentChannel.avatarUrl)
                              ? NetworkImage(
                                  pageProvider.currentChannel.avatarUrl)
                              : FileImage(
                                  File(pageProvider.currentChannel.avatarUrl))
